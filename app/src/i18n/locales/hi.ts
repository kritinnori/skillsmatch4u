...
const translations: Translations = {
  ...
  results: {
    ...
    noCoursesDescription:
      "इस करियर के लिए अभी हमें कोई कोर्स सुझाव नहीं मिला।",
    coursesUnavailableTitle: "कोर्स सुझाव लोड नहीं हो सके",
    coursesUnavailableDescription:
      "कोर्स खोजते समय कुछ गड़बड़ हुई। ऊपर दिया गया करियर मिलान अभी भी मान्य है — कृपया थोड़ी देर बाद फिर कोशिश करें।",
    noJobsTitle: "दिखाने के लिए कोई नौकरी नहीं",
    noJobsDescription:
      "इस करियर के लिए अभी हमें कोई नौकरी सूचीबद्ध नहीं मिली।",
    jobsUnavailableTitle: "नौकरी सुझाव लोड नहीं हो सके",
    jobsUnavailableDescription:
      "भूमिकाएँ खोजते समय कुछ गड़बड़ हुई। ऊपर दिया गया करियर मिलान अभी भी मान्य है — कृपया थोड़ी देर बाद फिर कोशिश करें।",
