...
const translations: Translations = {
  ...
  home: {
    ...
    howItWorksSubtitle: "তিনটি সহজ ধাপে আপনার আদর্শ ক্যারিয়ার পথ খুঁজুন।",
    step1Title: "কুইজ দিন",
    step1Body: "আপনার দক্ষতা, আগ্রহ এবং কাজের ধরন সম্পর্কে প্রশ্নের উত্তর দিন।",
    step2Title: "AI বিশ্লেষণ",
    step2Body: "আমাদের AI আপনার উত্তর বিশ্লেষণ করে উপযুক্ত ক্যারিয়ার খুঁজে বের করে।",
    step3Title: "সুপারিশ পান",
    step3Body: "আপনার ক্যারিয়ার মিল, কোর্স এবং চাকরির পরামর্শ পান।",
    ctaTitle: "আপনার সঠিক ক্যারিয়ার খুঁজতে প্রস্তুত?",
    ctaSubtitle: "আজই আপনার ব্যক্তিগত ক্যারিয়ার মূল্যায়ন শুরু করুন।",
    ctaNote: "মাত্র কয়েক মিনিট • বিনামূল্যে • ক্রেডিট কার্ডের প্রয়োজন নেই",
  },
  quiz: {
